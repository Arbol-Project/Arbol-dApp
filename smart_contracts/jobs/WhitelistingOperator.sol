 ...
 */
contract Operator is SimpleWriteAccessController, AuthorizedReceiver, LinkTokenReceiver, OperatorInterface, WithdrawalInterface {
  ...
  function oracleRequest(
    ...
    require(hasAccess(sender, data), "No access");
